...
public class MainFragment extends BaseFragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            mFragments[SECOND] = SendExpressFragment.newInstance();
            mFragments[THIRD] = OwnFragment.newInstance();
            ...
            mFragments[SECOND] = findChildFragment(SendExpressFragment.class);
            mFragments[THIRD] = findChildFragment(OwnFragment.class);
        }
    ...
    private void initView(View view) {
        ...
        mBottomBar
                .addItem(new BottomBarTab(_mActivity, R.drawable.ic_home_24dp, "首页"))
                .addItem(new BottomBarTab(_mActivity, R.drawable.ic_send_24dp, "寄快递"))
                .addItem(new BottomBarTab(_mActivity, R.drawable.ic_android_24dp, "我"));
